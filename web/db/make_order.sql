create or replace procedure make_order (order_id in varchar2, user_id in varchar2, service_id in varchar2, date_of_order date, start_time long, duration number, completed number, deleted number)
is
begin
